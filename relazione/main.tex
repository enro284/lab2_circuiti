...
\begin{minipage}[b]{0.6\textwidth}
	...
	\captionof{figure}{Schema elettrico del circuito. I punti $v_g, v_w, v_m, v_t$ sono stati collegati agli analog input di ELVIS II per le relative misure di tensione. I pedici g,w,m,t sono relativi ai rami del generatore, woofer, midrange e tweeter, i componenti non ideali sono disegnati in blu.}
\end{minipage}
