...
aspettiamo che: il woofer abbia un massimo a basse frequenze e un
...
$1$ \textmu{s} a cambiare canale da \texttt{A0} a \texttt{A1}, generando uno
...
ottenuto due stime: una teorica e una sperimentale, compatibili
tra loro.
