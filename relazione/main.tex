...
\begin{equation*}
	f_{c}^{sper} = (10.61 \pm 0.03) \text{ kHz}
\end{equation*}

\noindent
La frequenza di risonanza del midrange attesa è
\begin{equation*}
	f_{r}^{teo} = (10.65 \pm 0.10)  \text{ kHz}
\end{equation*}
...
\begin{equation*}
	f_{r}^{teo} = (10.65 \pm 0.10)\  \text{ kHz} \hspace{2cm} \frac{\Delta f_{r}}{f_{r}} = 1.0 \ \%
\end{equation*}
...
$11.2$ kHz) il grafico delle fasi con una retta (\cref{fig:phase_sweep}). In
questo modo abbiamo misurato:
